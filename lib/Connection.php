...
class Connection implements ConnectionInterface
{
  ...
  //
    ...
    public function call($method, $params = null)
    {
        ...
        if ($request->error) {
            throw Exception::factory($this, $request);
        }
    ...
    {
        if (array_key_exists('session', $this->context)) {
    ...
    public function getUri()
    {
        ...
        if (!empty($this->context)) {
            $backend_uri .= '?' . http_build_query($this->context);
        }
        return $backend_uri;
    }
  ...
  //
    ...
    protected function connect()
    {
        ...
        switch ($scheme) {
            ...
            case 'https':
                $this->connection = $this->getHttpConnection($backend_uri);
                break;
            case 'ws':    // Fall through
            case 'wss':
                $this->connection = $this->getWebsocketConnection($backend_uri);
                break;
            default:
